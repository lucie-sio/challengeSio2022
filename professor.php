    ...
    <?php if ($data[0][$choice] === '1'): ?>
        <div class="col-md-4 text-center">
            <div class="card text-white bg-<?= $colors[$choice] ?> mb-3 mx-auto" style="max-width: 15rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title"><?= professorCountCard($choice); ?> fiches disponibles</h5>
                    <?php if(professorCountCard($choice) > 0): ?>
                        <p class="card-text"><a href="./classe?<?= $choice ?>"><button class="btn btn-light">Élèves de <?= $choice ?></button></a></p>
                    <?php else: ?>
