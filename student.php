...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="col-md-1"></div>
            ...
            <div class="col-md-2"><a href="formComputer.php"><img class="img-fluid" src="./image/desktop-add" alt=""></a></div>
            <?php else: ?>
            <div class="col-md-2"><a href="formComputer.php"><img class="img-fluid" src="./image/desktop-modify" alt=""></a></div>
            <?php endif; ?>

            <!-- ICONE ORDINATEUR PORTABLE -->
            <?php if(empty($equipment[1])): ?>
            <div class="col-md-2"><a href="formPC.php"><img class="img-fluid" src="./image/laptop-add" alt=""></a></div>
            <?php else: ?>
            <div class="col-md-2"><a href="formPC.php"><img class="img-fluid" src="./image/laptop-modify" alt=""></a></div>
            <?php endif; ?>
            
            <!-- ICONE TABLETTE -->
            <?php if(empty($equipment[2])): ?>
            <div class="col-md-2"><a href="formTablet.php"><img class="img-fluid" src="./image/tablet-add" alt=""></a></div>
            <?php else: ?>
            <div class="col-md-2"><a href="formTablet.php"><img class="img-fluid" src="./image/tablet-modify" alt=""></a></div>
            <?php endif; ?>

            <!-- ICONE TELEPHONE PORTABLE -->
            <?php if(empty($equipment[3])): ?>
            <div class="col-md-2"><a href="formPhone.php"><img class="img-fluid" src="./image/phone-add" alt=""></a></div>
            <?php else: ?>
            <div class="col-md-2"><a href="formPhone.php"><img class="img-fluid" src="./image/phone-modify" alt=""></a></div>
            <?php endif; ?>

            <!-- ICONE EQUIPEMENT casque, micro, webcam -->
            <?php if(empty($data[0]['HEADPHONES'] && empty($data[0]['MICROPHONE']) && empty($data[0]['WEBCAM']))): ?>
            <div class="col-md-2"><a href="formEquipment.php"><img class="img-fluid" src="./image/gear-add" alt=""></a></div>
            <?php else: ?>
            <div class="col-md-2"><a href="formEquipment.php"><img class="img-fluid" src="./image/gear-modify" alt=""></a></div>
            <?php endif; ?>
        <div class="col-md-1"></div>
    </div>
    <div class="row mt-5">
